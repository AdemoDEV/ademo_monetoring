...
// const PRODUCT_URLS = ["https://www.guizettefamily.com/produit/case-etb-ev6-5/"];
...
export async function Ademo_CheckGuiztteFamily(browser, PRODUCT_URLS) {
    ...
    try {
        ...
        if (product.price == "Non disponible") {
            ...
            await notifyDiscord(product, DISCORD_WEBHOOK_URL, "guizettefamily", false, "non", true, "✅ Disponible", true);
        }
    } catch (err) {
